...
MealPlan.create!(name: 'Vegetarian', daily_price: 39, description: 'A plant based plan in accordance with one of our other plans', detailed_description: 'A plant based plan which provides a nourishing and balanced diet, consisting of wholegrains, slow energy release carbohydrates, healthy fats and plant based proteins.')
